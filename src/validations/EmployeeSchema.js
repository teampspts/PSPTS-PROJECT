...
export const EmployeeSchema = Yup.object().shape({
  ...
  employeeOfferLetterReleaseDate: Yup.date().required(
    "Employee Offer Letter Release Date is required"
  )
  .min(new Date(), "Employee Offer Letter Release Date  cannot be in the past"),
  ...
  hikeLetterDate: Yup.date().nullable()
  .min(new Date(), "Hike Letter Date cannot be in the past"),
