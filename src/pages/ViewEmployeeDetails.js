...
const ViewEmployeeDetails = () => {
  ...
  const buttonfunction = () => {
    const details = data.find(
      (obj) => obj.id.toString().toLowerCase() === value.toLowerCase() || obj.firstName.toLowerCase() === value.toLowerCase() ||

      obj.lastName.toLowerCase() === value.toLowerCase()

      ||

      (obj.firstName.toLowerCase() + ' ' + obj.lastName.toLowerCase()) === value.toLowerCase() );
